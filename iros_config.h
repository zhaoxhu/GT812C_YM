...
#ifdef HAVE_MRV_SWITCH
#define CPU_ONLY_PERMIT_TAGGED_PKT_TO_UNI	MODULE_YES
#endif
/* added by zhaoxh@2017-04-5,for boot rease protect test */
#define HAVE_BOOT_ERASE_TEST_CMD MODULE_YES
